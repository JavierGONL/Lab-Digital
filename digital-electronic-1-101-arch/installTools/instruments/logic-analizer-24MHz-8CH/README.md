...
* Seguir las instrucciones de Instalación para sistemas basados en Arch Linux: [Instrucciones de Instalación](https://support.saleae.com/logic-software/sw-installation#ubuntu-instructions)
